...
const UUID = process.env.UUID || '988bec19-7bb9-456f-8d26-d1c87d276240';  // 在不同的平台运行了v1哪吒请修改UUID,否则会覆盖
...
const S5_PORT = process.env.S5_PORT || '3078';                   // socks5端口，支持多端口的可以填写，否则留空
