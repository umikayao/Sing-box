...
UUID = os.environ.get('UUID', '363328ed-3a12-4742-a77a-6ca0954020a3')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'adkpy.umika.cc.cd')        # Argo固定隧道域名,留空即使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiMjI0OWIxNGM3ZDZhNmUyOTg3ZTQ1ZTUyYWY0YTAwMGUiLCJ0IjoiMmFlYzdkOTUtYTNiMi00MDY0LTg3MzQtYmEwYzVkYmIzYmQxIiwicyI6IlpUTmlaVFE0Tm1ZdFpHUmxOeTAwWlRBeExUazBPREl0WVdKaU56TXpOek5sTVRCbSJ9')            # Argo固定隧道密钥,留空即使用临时隧道
ARGO_PORT = int(os.environ.get('ARGO_PORT', '8060'))   # Argo端口,使用固定隧道token需在cloudflare后台设置端口和这里一致
...
HY2_PORT_STR = os.environ.get('HY2_PORT', '3319')          # hy2端口,支持多端口的玩具可以填写开启,否则保持不变
ANYTLS_PORT_STR = os.environ.get('ANYTLS_PORT', '')    # AnyTLS端口，支持多端口的可以填写，否则留空
REALITY_PORT_STR = os.environ.get('REALITY_PORT', '3319')  # Reality端口,支持多端口的玩具可以填写开启,否则保持不变
